...
import kProcess from '@/assets/imgs/projekter/kaffemik/kprocess.jpeg'
...
import kPoster from '@/assets/imgs/projekter/kaffemik/kmPoster.png'
import kMovie from '@/assets/mp4s/kmMovie.mp4'
...
import hupPoster from '@/assets/imgs/projekter/HUP/hupPoster.png'
import hupFilm from '@/assets/mp4s/hupmovie.mp4'
...
export const workProjects = [
  ...
  { id: 3, 
    ...
    video: [ehMovie],
    thumbs2: [ eh4, eh6, eh7],
    moreText2: 'I udviklingen har jeg arbejdet med en kombination af importerede 3D-assets og specialeffekter for at opbygge fortællingens stemning. <br><br>Jeg har hentet licensfrie 3D-modeller ind, og brugt raycaster til at interagere med objekter i scenen. <br><br>For at skabe en stærk visuel atmosfære har jeg brugt både UnrealBloomPass og FilmPass, som tilsammen tilføjer et drømmende og forvrænget udtryk. <br><br>Disse postprocessing-effekter og shaders forstærker spillets æstetik og oplevelse af et forladt, fremmed univers. <br><br><br><b><u>Værktøjer:</u></b><br>Three.js (webbaseret 3D og interaktion)<br>HTML, CSS & JavaScript<br>VS Code (kodeeditor)<br><br>',
  },
  ...
  { id: 1, 
    ...
    moreText2:'Jeg startede med idéudvikling og en masse skitser, og begyndte derefter at modellere mine low-poly figurer i Blender. Da det var mit første projekt i programmet, eksperimenterede jeg meget undervejs. <br><br>Resultatet blev en række ukonventionelle modeller - men jeg lærte en masse om Blender og lykkedes med at føre min idé helt i mål.<br><br><br><b><u>Værktøjer:</u></b><br>Blender (3D-modellering)<br><br>',
  },
